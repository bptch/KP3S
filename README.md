...
⭕️ Провести калибровку Pid экструдера и стола через Меню -  Конфигурация - Другие настройки - Температура(или запустить в печать PidCalibration.gcode) После зайти в Меню-Конфигурация-Сохранить настройки
